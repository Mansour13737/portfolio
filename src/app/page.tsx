...
export default function Home() {
  return (
    <div className=" flex flex-col bg-white items-center relative  pt-7 w-screen h-screen border-t-25 border-black">
      ...
      <div className="bg-[black] w-screen fixed  h-[50px] lg:h-8 lg:mt-12 bottom-0"></div>
    </div>
  );
}
