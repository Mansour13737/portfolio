...
export default function Home() {
  return (
    <div className=" flex flex-col bg-white items-center  p-7 w-screen h-screen border-t-16 border-black">
      ...
      <div className="bg-[#030303] w-screen h-[28px] lg:h-8 lg:mt-12 mt-4"></div>
    </div>
  );
}
