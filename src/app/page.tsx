...
export default function Home() {
  return (
    <div className=" flex flex-col bg-[url('/1.JPG')] bg-cover bg-center items-center relative m-0 pt-7 w-full h-screen border-t-25 border-black">
      ...
      <h2 className=" text-3xl md:text-5xl font-[Poppins] text-center cursor-none leading-20 tracking-wider opacity-80 hover:blur-[1px]  "><b>Not</b> everything needs an <span className="first-letter:font-bold text-4xl">introduction</span></h2>
